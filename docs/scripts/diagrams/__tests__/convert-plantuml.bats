#!/usr/bin/env bats
# =============================================================================
# convert-plantuml.bats - Unit tests for convert-plantuml.sh
# =============================================================================
...
FORMAT="plantuml"
EXT="puml"
SCRIPT_NAME="convert-plantuml.sh"
...
@test "does nothing when no source files exist" {
  ...
  # When: convert-plantuml.sh を実行する
...
@test "converts all multiple files" {
  # Given: 複数の plantuml ソースファイルが存在する
  cd "$TEST_DIR"
