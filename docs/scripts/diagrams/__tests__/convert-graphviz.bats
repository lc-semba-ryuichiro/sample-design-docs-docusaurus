#!/usr/bin/env bats
# =============================================================================
# convert-graphviz.bats - Unit tests for convert-graphviz.sh
# =============================================================================
...
FORMAT="graphviz"
EXT="dot"
SCRIPT_NAME="convert-graphviz.sh"
...
@test "does nothing when no source files exist" {
  ...
  # When: convert-graphviz.sh を実行する
...
@test "converts all multiple files" {
  # Given: 複数の graphviz ソースファイルが存在する
  cd "$TEST_DIR"
